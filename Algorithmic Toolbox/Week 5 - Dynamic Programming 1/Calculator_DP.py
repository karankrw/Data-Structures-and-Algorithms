...
# -*- coding: utf-8 -*-
"""
Created on Sun May 31 23:46:00 2020
...
def dynamic_sequence(n):
    ...
    while current_value != 1:
        options_list = [current_value - 1]
        if current_value % 2 == 0:
            options_list.append(current_value // 2)
        if current_value % 3 == 0:
            options_list.append(current_value // 3)
        
        current_value = min([(c, operations_count[c]) for c in options_list],
                             key = lambda x: x[1])[0]
